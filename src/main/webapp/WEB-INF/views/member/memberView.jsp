...
<body>
	<form id="formView" name="formView" method="post" action="/lucky/member/memberView">
					...
					<h4>
						...
						<table class="table align-middle table-bordered border-primary">
							<tr>
								...
								<td style="width: 35%">
									<input class="form-control" type="text" id="ifmmId" style="width:250px" value="<c:out value="${item.ifmmId}"/>" readonly>
								</td>
								<td class="table-secondary" style="width: 15%"><strong>이름</strong></td>
								<td style="width: 35%">
									<input class="form-control" type="text" id="ifmmName" style="width:250px" value="<c:out value="${item.ifmmName}"/>" readonly>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input class="form-control" type="text"  style="width:200px" id="ifmmPassword" name="ifmmPassword" value="<c:out value="${item.ifmmPassword}"/>" readonly>
								</td>
							...
							<tr>
								...
								<td>
									<input class="form-control" type="text" id="ifmmDob" style="width:250px" value="<c:out value="${item.ifmmDob}"/>" readonly>
								</td>
							</tr>
							<tr>
								<td class="table-secondary" style="width: 15%"><strong>휴대폰번호</strong></td>
								<td>
									<input class="form-control" type="text"  style="width:250px" value="<c:out value="${item.ifmpNumber}"/>" readonly>
								...
								<td>
									<input class="form-control" type="text"  style="width:250px"  value="<c:out value="${item.ifmeEmailFull}"/>" readonly>
			...
			<div class="row">
				<div class="col-6 col-sm-6">
					<div class="mb-3">
						...
						<a href="/lucky/member/memberDele?ifmmSeq=<c:out value="${item.ifmmSeq}"/>" id="btnDelete">삭제(진짜)</a>
						<a href="/lucky/member/memberNele?ifmmSeq=<c:out value="${item.ifmmSeq}"/>" id="btnupdateDelete">삭제(가짜)</a>
					</div>
				</div>
...
goList = function(){
	$("#formView").attr("action", "/lucky/member/memberList");
	$("#formView").submit();
};

goEdit = function(){
	$("#formView").attr("action", "/lucky/member/memberEdit");
	$("#formView").submit();
};
